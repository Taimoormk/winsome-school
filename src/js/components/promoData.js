export const promoData = [
  ...
  },
  {
    id: 2,
    title: "Reggio Emilia",
    description: "We focus on effective teaching of litreacy and numeracy whilst also being inspired by a Reggio Emilia apporach in our teaching and learning. Educators respond to children’s ideas, and in turn link these ideas to extend each student’s knowledge in multiple areas of learning.<br />Projects provide opportunities for students to work in collaboration; exploring ideas and testing hypotheses.",
    imageLink: "./img/reggio-emilia-photo.jpg",
    readMoreLink: "",
    imageDirection: "right",
    textDirection: "left",
    boxShadow: "$shadow-top",
  },
  {
    id: 3,
    title: "Middle School",
